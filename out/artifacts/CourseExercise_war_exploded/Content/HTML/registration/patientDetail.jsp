    ...
    <div>
        ...
        <fieldset>
            ...
            <%
                ...
                String a2012str = null;
                if (a20.getA2012() != null)
                    a2012str = simFormat.format(a20.getA2012());
                else
                    a2012str = simFormat.format(new java.util.Date());
            %>
            <form action="/servlet/registration/PatientUpdateServlet" method="post">
                <div class="EnterContent">
                    <div class="EnterContent-group">
                        ...
                        <input type="text" class="EnterContent-input shortwidth" id="a202" name="a202" value="<%=StringTools.nullToEmpty(a20.getA202())%>">
                    </div>
                    <div class="EnterContent-group">
                    ...
                    <div class="EnterContent-group">
                        ...
                        <input type="text" class="EnterContent-input shortwidth" id="a205" name="a205"  value="<%=StringTools.nullToEmpty(a20.getA205())%>">
                    </div>
                    <div class="EnterContent-group">
                    ...
                    <div class="EnterContent-group">
                        ...
                        <input type="text" class="EnterContent-input longwidth" id="a207" name="a207" value="<%=StringTools.nullToEmpty(a20.getA207())%>">
                    </div>
                    <div class="EnterContent-group">
                        <label class="EnterContent-lable" for="a208">常住住址</label>
                        <input type="text" class="EnterContent-input longwidth" id="a208" name="a208"  value="<%=StringTools.nullToEmpty(a20.getA208())%>">
                    </div>

                    <hr style=" margin-right: 12%; margin-top: 80px; margin-bottom: 80px">
                    <div class="EnterContent-group">
                        <label class="EnterContent-lable" for="a209">初查</label>
                        <input type="text" class="EnterContent-input longwidth" id="a209" name="a209" value="<%=StringTools.nullToEmpty(a20.getA209())%>">
                    </div>
                    <div class="EnterContent-group">
                    ...
                    <div class="EnterContent-group">
                        ...
                        <input type="text" class="EnterContent-input longwidth" id="a2011" name="a2011" value="<%=StringTools.nullToEmpty(a20.getA2011())%>">
                    </div>
                    <div class="EnterContent-group">
