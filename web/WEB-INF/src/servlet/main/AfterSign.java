...
//        System.out.println(passwordMd5);
        ...
        if (a10 == null){
            ...
            out.print("<script language='javascript'>alert('ÕËºÅÃÜÂë´íÎóÇëÖØÐÂµÇÂ½');window.location.href='"+req.getContextPath()+"/Content/HTML/main/signin.html'</script>");
//            resp.sendRedirect(req.getContextPath() +  "/Content/HTML/main/signin.html");
        }
//        ceshi3
//        System.out.println(a10.toString());
        req.getSession().setAttribute("a10", a10);
        // TODO: 2018/1/3 ÅÐ¶ÏÉí·Ý½ÇÉ«Ìø×ªÒ³Ãæ
        if (a10.getA105() == 1)
            resp.sendRedirect(req.getContextPath() + "/Content/HTML/registration/register.jsp");
        else if(a10.getA105() == 5)
