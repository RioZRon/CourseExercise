...
@WebServlet(name = "RegistrationSelectDealWithNameIdServlet", urlPatterns = "/servlet/registration/RegistrationSelectDealWithNameIdServlet")
public class RegistrationSelectDealWithNameId extends HttpServlet {
    @Override
