...
@WebServlet(name = "PrescriptionDetailPrintServlet", urlPatterns = "/servlet/outpatientDoctor/PrescriptionDetailPrintServlet")
public class PrescriptionDetailPrint extends HttpServlet{
    @Override
