    ...
    <main class="SearchContent">
        ...
        <table style="margin-top: 50px" class="confermation-table" border="1px solid">
            ...
            <tr>
                ...
                <th><input type="text" class="maininput" id="name" name="name" value="和润" readonly></th>
                <th><input type="datetime-local" class="maininput" id="registrationDate" value="2018-01-02T13:53" readonly></th>
                <th><input type="text" class="maininput" id="remark" name="remark" value="紧急"readonly></th>
                <th><a href="out.html"><img style="margin-left: 10%; margin-top: 10px" height="25px" src="<%=basePath%>/res/pic/PNG/查询.png" alt="详细"></a></th>
            </tr>
        </table>
